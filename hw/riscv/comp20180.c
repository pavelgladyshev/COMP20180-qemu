 ...
 *
 * Various limits defined by COMP20180_SOCKETS_MAX_BITS, COMP20180_CPUS_MAX_BITS,
 * and COMP20180_IRQCHIP_MAX_GUESTS_BITS are tuned for maximum utilization
 * of virt machine physical address space.
 */

#define COMP20180_IMSIC_GROUP_MAX_SIZE      (1U << IMSIC_MMIO_GROUP_MIN_SHIFT)
#if COMP20180_IMSIC_GROUP_MAX_SIZE < \
    IMSIC_GROUP_SIZE(COMP20180_CPUS_MAX_BITS, COMP20180_IRQCHIP_MAX_GUESTS_BITS)
#error "Can't accommodate single IMSIC group in address space"
#endif

#define COMP20180_IMSIC_MAX_SIZE            (COMP20180_SOCKETS_MAX * \
                                        COMP20180_IMSIC_GROUP_MAX_SIZE)
#if 0x4000000 < COMP20180_IMSIC_MAX_SIZE
...
static const MemMapEntry comp20180_memmap[] = {
    ...
    [COMP20180_PLATFORM_BUS] = {  0x4000000,     0x2000000 },
    [COMP20180_PLIC] =         {  0xc000000, COMP20180_PLIC_SIZE(COMP20180_CPUS_MAX * 2) },
    [COMP20180_APLIC_M] =      {  0xc000000, APLIC_SIZE(COMP20180_CPUS_MAX) },
    [COMP20180_APLIC_S] =      {  0xd000000, APLIC_SIZE(COMP20180_CPUS_MAX) },
    [COMP20180_UART0] =        { 0x10000000,         0x100 },
    [COMP20180_COMP20180IO] =       { 0x10001000,        0x1000 },
    [COMP20180_FW_CFG] =       { 0x10100000,          0x18 },
    [COMP20180_FLASH] =        { 0x20000000,     0x4000000 },
    [COMP20180_IMSIC_M] =      { 0x24000000, COMP20180_IMSIC_MAX_SIZE },
    [COMP20180_IMSIC_S] =      { 0x28000000, COMP20180_IMSIC_MAX_SIZE },
...
#define COMP2018032_HIGH_PCIE_MMIO_BASE  0x300000000ULL
#define COMP2018032_HIGH_PCIE_MMIO_SIZE  (4 * GiB)
                                       ...
                                       const char *alias_prop_name)
{
    ...
    qdev_prop_set_uint64(dev, "sector-length", COMP20180_FLASH_SECTOR_SIZE);
                            ...
                            MemoryRegion *sysmem)
{
    ...
    assert(QEMU_IS_ALIGNED(size, COMP20180_FLASH_SECTOR_SIZE));
    assert(size / COMP20180_FLASH_SECTOR_SIZE <= UINT32_MAX);
    qdev_prop_set_uint32(dev, "num-blocks", size / COMP20180_FLASH_SECTOR_SIZE);
...
static void create_pcie_irq_map(RISCVCOMP20180State *s, void *fdt, char *nodename,
...
static void create_fdt_socket_cpus(RISCVCOMP20180State *s, int socket,
...
static void create_fdt_socket_memory(RISCVCOMP20180State *s,
                                     const MemMapEntry *memmap, int socket)
{
    ...
    addr = memmap[COMP20180_DRAM].base + riscv_socket_mem_offset(ms, socket);
...
static void create_fdt_socket_clint(RISCVCOMP20180State *s,
                                    const MemMapEntry *memmap, int socket,
                                    uint32_t *intc_phandles)
{
    int cpu;
    ...
    clint_addr = memmap[COMP20180_CLINT].base + (memmap[COMP20180_CLINT].size * socket);
    ...
    qemu_fdt_setprop_cells(ms->fdt, clint_name, "reg",
        0x0, clint_addr, 0x0, memmap[COMP20180_CLINT].size);
...
static void create_fdt_socket_aclint(RISCVCOMP20180State *s,
                                     const MemMapEntry *memmap, int socket,
                                     uint32_t *intc_phandles)
{
    int cpu;
    ...
    if (s->aia_type != COMP20180_AIA_TYPE_APLIC_IMSIC) {
        addr = memmap[COMP20180_CLINT].base + (memmap[COMP20180_CLINT].size * socket);
    ...
    if (s->aia_type == COMP20180_AIA_TYPE_APLIC_IMSIC) {
        addr = memmap[COMP20180_CLINT].base +
               (RISCV_ACLINT_DEFAULT_MTIMER_SIZE * socket);
        size = RISCV_ACLINT_DEFAULT_MTIMER_SIZE;
    } else {
        addr = memmap[COMP20180_CLINT].base + RISCV_ACLINT_SWI_SIZE +
            (memmap[COMP20180_CLINT].size * socket);
        size = memmap[COMP20180_CLINT].size - RISCV_ACLINT_SWI_SIZE;
    }
    ...
    if (s->aia_type != COMP20180_AIA_TYPE_APLIC_IMSIC) {
        addr = memmap[COMP20180_ACLINT_SSWI].base +
            (memmap[COMP20180_ACLINT_SSWI].size * socket);
        name = g_strdup_printf("/soc/sswi@%lx", addr);
        qemu_fdt_add_subnode(ms->fdt, name);
        qemu_fdt_setprop_string(ms->fdt, name, "compatible",
            "riscv,aclint-sswi");
        qemu_fdt_setprop_cells(ms->fdt, name, "reg",
            0x0, addr, 0x0, memmap[COMP20180_ACLINT_SSWI].size);
        qemu_fdt_setprop(ms->fdt, name, "interrupts-extended",
...
static void create_fdt_socket_plic(RISCVCOMP20180State *s,
                                   const MemMapEntry *memmap, int socket,
                                   ...
                                   uint32_t *plic_phandles)
{
    ...
    plic_addr = memmap[COMP20180_PLIC].base + (memmap[COMP20180_PLIC].size * socket);
    ...
    qemu_fdt_setprop_cells(ms->fdt, plic_name, "reg",
        0x0, plic_addr, 0x0, memmap[COMP20180_PLIC].size);
    qemu_fdt_setprop_cell(ms->fdt, plic_name, "riscv,ndev",
                          COMP20180_IRQCHIP_NUM_SOURCES - 1);
    ...
    if (!socket) {
        platform_bus_add_all_fdt_nodes(ms->fdt, plic_name,
                                       memmap[COMP20180_PLATFORM_BUS].base,
                                       memmap[COMP20180_PLATFORM_BUS].size,
                                       COMP20180_PLATFORM_BUS_IRQ);
    }
...
static void create_fdt_one_imsic(RISCVCOMP20180State *s, hwaddr base_addr,
                                 ...
                                 bool m_mode, uint32_t imsic_guest_bits)
{
    ...
    for (socket = 0; socket < socket_count; socket++) {
        imsic_addr = base_addr + socket * COMP20180_IMSIC_GROUP_MAX_SIZE;
...
static void create_fdt_imsic(RISCVCOMP20180State *s, const MemMapEntry *memmap,
                             uint32_t *phandle, uint32_t *intc_phandles,
                             uint32_t *msi_m_phandle, uint32_t *msi_s_phandle)
{
    ...
    *msi_s_phandle = (*phandle)++;
    ...
    if (!kvm_enabled()) {
        /* M-level IMSIC node */
        create_fdt_one_imsic(s, memmap[COMP20180_IMSIC_M].base, intc_phandles,
                             *msi_m_phandle, true, 0);
    }

    /* S-level IMSIC node */
    create_fdt_one_imsic(s, memmap[COMP20180_IMSIC_S].base, intc_phandles,
                         *msi_s_phandle, false,
                         imsic_num_bits(s->aia_guests + 1));

}

static void create_fdt_one_aplic(RISCVCOMP20180State *s, int socket,
                                 ...
                                 bool m_mode, int num_harts)
{
    ...
    if (s->aia_type == COMP20180_AIA_TYPE_APLIC) {
...
static void create_fdt_socket_aplic(RISCVCOMP20180State *s,
                                    const MemMapEntry *memmap, int socket,
                                    ...
                                    int num_harts)
{
    ...
    if (!kvm_enabled()) {
        /* M-level APLIC node */
        aplic_addr = memmap[COMP20180_APLIC_M].base +
                     (memmap[COMP20180_APLIC_M].size * socket);
        create_fdt_one_aplic(s, socket, aplic_addr, memmap[COMP20180_APLIC_M].size,
    ...
    /* S-level APLIC node */
    aplic_addr = memmap[COMP20180_APLIC_S].base +
                 (memmap[COMP20180_APLIC_S].size * socket);
    create_fdt_one_aplic(s, socket, aplic_addr, memmap[COMP20180_APLIC_S].size,
...
static void create_fdt_pmu(RISCVCOMP20180State *s)
{
    char *pmu_name;
    MachineState *ms = MACHINE(s);
...
static void create_fdt_sockets(RISCVCOMP20180State *s, const MemMapEntry *memmap,
                               uint32_t *phandle,
...
static void create_fdt_virtio(RISCVCOMP20180State *s, const MemMapEntry *memmap,
                              uint32_t irq_virtio_phandle)
{
    int i;
    char *name;
    ...
    for (i = 0; i < COMP20180IO_COUNT; i++) {
        name = g_strdup_printf("/soc/virtio_mmio@%lx",
            (long)(memmap[COMP20180_COMP20180IO].base + i * memmap[COMP20180_COMP20180IO].size));
        qemu_fdt_add_subnode(ms->fdt, name);
        qemu_fdt_setprop_string(ms->fdt, name, "compatible", "virtio,mmio");
        qemu_fdt_setprop_cells(ms->fdt, name, "reg",
            0x0, memmap[COMP20180_COMP20180IO].base + i * memmap[COMP20180_COMP20180IO].size,
            0x0, memmap[COMP20180_COMP20180IO].size);
        ...
        if (s->aia_type == COMP20180_AIA_TYPE_NONE) {
            ...
            qemu_fdt_setprop_cells(ms->fdt, name, "interrupts",
                                   COMP20180IO_IRQ + i, 0x4);
        }
        g_free(name);
    }
}

static void create_fdt_pcie(RISCVCOMP20180State *s, const MemMapEntry *memmap,
                            uint32_t irq_pcie_phandle,
                            uint32_t msi_pcie_phandle)
{
    char *name;
    ...
    name = g_strdup_printf("/soc/pci@%lx",
        (long) memmap[COMP20180_PCIE_ECAM].base);
    qemu_fdt_add_subnode(ms->fdt, name);
    ...
    qemu_fdt_setprop_cells(ms->fdt, name, "bus-range", 0,
        memmap[COMP20180_PCIE_ECAM].size / PCIE_MMCFG_SIZE_MIN - 1);
    qemu_fdt_setprop(ms->fdt, name, "dma-coherent", NULL, 0);
    if (s->aia_type == COMP20180_AIA_TYPE_APLIC_IMSIC) {
        qemu_fdt_setprop_cell(ms->fdt, name, "msi-parent", msi_pcie_phandle);
    }
    qemu_fdt_setprop_cells(ms->fdt, name, "reg", 0,
        memmap[COMP20180_PCIE_ECAM].base, 0, memmap[COMP20180_PCIE_ECAM].size);
    qemu_fdt_setprop_sized_cells(ms->fdt, name, "ranges",
        1, FDT_PCI_RANGE_IOPORT, 2, 0,
        2, memmap[COMP20180_PCIE_PIO].base, 2, memmap[COMP20180_PCIE_PIO].size,
...
static void create_fdt_reset(RISCVCOMP20180State *s, const MemMapEntry *memmap,
                             uint32_t *phandle)
{
    char *name;
    ...
    name = g_strdup_printf("/soc/test@%lx",
        (long)memmap[COMP20180_TEST].base);
    qemu_fdt_add_subnode(ms->fdt, name);
    {
    ...
    qemu_fdt_setprop_cells(ms->fdt, name, "reg",
        0x0, memmap[COMP20180_TEST].base, 0x0, memmap[COMP20180_TEST].size);
...
static void create_fdt_uart(RISCVCOMP20180State *s, const MemMapEntry *memmap,
                            uint32_t irq_mmio_phandle)
{
    char *name;
    MachineState *ms = MACHINE(s);

    name = g_strdup_printf("/soc/serial@%lx", (long)memmap[COMP20180_UART0].base);
    qemu_fdt_add_subnode(ms->fdt, name);
    qemu_fdt_setprop_string(ms->fdt, name, "compatible", "ns16550a");
    qemu_fdt_setprop_cells(ms->fdt, name, "reg",
        0x0, memmap[COMP20180_UART0].base,
        0x0, memmap[COMP20180_UART0].size);
...
static void create_fdt_rtc(RISCVCOMP20180State *s, const MemMapEntry *memmap,
                           uint32_t irq_mmio_phandle)
{
    char *name;
    MachineState *ms = MACHINE(s);

    name = g_strdup_printf("/soc/rtc@%lx", (long)memmap[COMP20180_RTC].base);
    qemu_fdt_add_subnode(ms->fdt, name);
    qemu_fdt_setprop_string(ms->fdt, name, "compatible",
        "google,goldfish-rtc");
    qemu_fdt_setprop_cells(ms->fdt, name, "reg",
        0x0, memmap[COMP20180_RTC].base, 0x0, memmap[COMP20180_RTC].size);
    qemu_fdt_setprop_cell(ms->fdt, name, "interrupt-parent",
        irq_mmio_phandle);
    if (s->aia_type == COMP20180_AIA_TYPE_NONE) {
...
static void create_fdt_flash(RISCVCOMP20180State *s, const MemMapEntry *memmap)
{
    char *name;
    MachineState *ms = MACHINE(s);
    hwaddr flashsize = comp20180_memmap[COMP20180_FLASH].size / 2;
...
static void create_fdt_fw_cfg(RISCVCOMP20180State *s, const MemMapEntry *memmap)
{
    char *nodename;
    MachineState *ms = MACHINE(s);
    hwaddr base = memmap[COMP20180_FW_CFG].base;
    hwaddr size = memmap[COMP20180_FW_CFG].size;
...
static void finalize_fdt(RISCVCOMP20180State *s)
{
                                     ...
                                     int base_hartid, int hart_count)
{
    ...
    ret = sifive_plic_create(
            memmap[COMP20180_PLIC].base + socket * memmap[COMP20180_PLIC].size,
            plic_hart_config, hart_count, base_hartid,
            COMP20180_IRQCHIP_NUM_SOURCES,
            ((1U << COMP20180_IRQCHIP_NUM_PRIO_BITS) - 1),
            COMP20180_PLIC_PRIORITY_BASE,
            COMP20180_PLIC_PENDING_BASE,
            COMP20180_PLIC_ENABLE_BASE,
            COMP20180_PLIC_ENABLE_STRIDE,
            COMP20180_PLIC_CONTEXT_BASE,
            COMP20180_PLIC_CONTEXT_STRIDE,
            memmap[COMP20180_PLIC].size);
...
static DeviceState *comp20180_create_aia(RISCVCOMP20180AIAType aia_type, int aia_guests,
                                    const MemMapEntry *memmap, int socket,
                                    int base_hartid, int hart_count)
{
    int i;
    ...
    bool msimode = aia_type == COMP20180_AIA_TYPE_APLIC_IMSIC;

    if (msimode) {
        if (!kvm_enabled()) {
            /* Per-socket M-level IMSICs */
            addr = memmap[COMP20180_IMSIC_M].base +
                   socket * COMP20180_IMSIC_GROUP_MAX_SIZE;
        ...
        addr = memmap[COMP20180_IMSIC_S].base + socket * COMP20180_IMSIC_GROUP_MAX_SIZE;
        for (i = 0; i < hart_count; i++) {
    ...
    if (!kvm_enabled()) {
        ...
        aplic_m = riscv_aplic_create(memmap[COMP20180_APLIC_M].base +
                                     socket * memmap[COMP20180_APLIC_M].size,
                                     memmap[COMP20180_APLIC_M].size,
                                     (msimode) ? 0 : base_hartid,
                                     (msimode) ? 0 : hart_count,
                                     COMP20180_IRQCHIP_NUM_SOURCES,
                                     COMP20180_IRQCHIP_NUM_PRIO_BITS,
                                     msimode, true, NULL);
    }

    /* Per-socket S-level APLIC */
    aplic_s = riscv_aplic_create(memmap[COMP20180_APLIC_S].base +
                                 socket * memmap[COMP20180_APLIC_S].size,
                                 memmap[COMP20180_APLIC_S].size,
                                 (msimode) ? 0 : base_hartid,
                                 (msimode) ? 0 : hart_count,
                                 COMP20180_IRQCHIP_NUM_SOURCES,
                                 COMP20180_IRQCHIP_NUM_PRIO_BITS,
...
static void create_platform_bus(RISCVCOMP20180State *s, DeviceState *irqchip)
{
    DeviceState *dev;
    SysBusDevice *sysbus;
    ...
    qdev_prop_set_uint32(dev, "num_irqs", COMP20180_PLATFORM_BUS_NUM_IRQS);
    qdev_prop_set_uint32(dev, "mmio_size", memmap[COMP20180_PLATFORM_BUS].size);
    sysbus_realize_and_unref(SYS_BUS_DEVICE(dev), &error_fatal);
    s->platform_bus_dev = dev;

    sysbus = SYS_BUS_DEVICE(dev);
    for (i = 0; i < COMP20180_PLATFORM_BUS_NUM_IRQS; i++) {
        int irq = COMP20180_PLATFORM_BUS_IRQ + i;
...
static void comp20180_machine_done(Notifier *notifier, void *data)
{
    ...
    fdt_load_addr = riscv_compute_fdt_addr(memmap[COMP20180_DRAM].base,
                                           memmap[COMP20180_DRAM].size,
                                           machine);
...
static void comp20180_machine_init(MachineState *machine)
{
    ...
    if (COMP20180_SOCKETS_MAX < socket_count) {
        error_report("number of sockets/nodes should be less than %d",
            COMP20180_SOCKETS_MAX);
        exit(1);
    }
        ...
        if (tcg_enabled()) {
            if (s->have_aclint) {
                if (s->aia_type == COMP20180_AIA_TYPE_APLIC_IMSIC) {
                    ...
                    riscv_aclint_mtimer_create(memmap[COMP20180_CLINT].base +
                    ...
                    riscv_aclint_swi_create(memmap[COMP20180_CLINT].base +
                            i * memmap[COMP20180_CLINT].size,
                    ...
                    riscv_aclint_mtimer_create(memmap[COMP20180_CLINT].base +
                        ...
                        RISCV_ACLINT_DEFAULT_MTIME,
                        RISCV_ACLINT_DEFAULT_TIMEBASE_FREQ, true);
                    riscv_aclint_swi_create(memmap[COMP20180_ACLINT_SSWI].base +
                            i * memmap[COMP20180_ACLINT_SSWI].size,
                        base_hartid, hart_count, true);
                }
            } else {
                /* Per-socket SiFive CLINT */
                riscv_aclint_swi_create(
                    memmap[COMP20180_CLINT].base + i * memmap[COMP20180_CLINT].size,
                    base_hartid, hart_count, false);
                riscv_aclint_mtimer_create(memmap[COMP20180_CLINT].base +
                        i * memmap[COMP20180_CLINT].size + RISCV_ACLINT_SWI_SIZE,
    ...
    sifive_test_create(memmap[COMP20180_TEST].base);

    /* VirtIO MMIO devices */
    for (i = 0; i < COMP20180IO_COUNT; i++) {
        sysbus_create_simple("virtio-mmio",
            memmap[COMP20180_COMP20180IO].base + i * memmap[COMP20180_COMP20180IO].size,
            qdev_get_gpio_in(virtio_irqchip, COMP20180IO_IRQ + i));
    }

    gpex_pcie_init(system_memory,
                   memmap[COMP20180_PCIE_ECAM].base,
    ...
    serial_mm_init(system_memory, memmap[COMP20180_UART0].base,
...
static void comp20180_set_aia_guests(Object *obj, const char *val, Error **errp)
{
    ...
    if (s->aia_guests < 0 || s->aia_guests > COMP20180_IRQCHIP_MAX_GUESTS) {
        error_setg(errp, "Invalid number of AIA IMSIC guests");
        error_append_hint(errp, "Valid values be between 0 and %d.\n",
                          COMP20180_IRQCHIP_MAX_GUESTS);
    }
}
...
static char *comp20180_get_aia(Object *obj, Error **errp)
{
    ...
    switch (s->aia_type) {
    case COMP20180_AIA_TYPE_APLIC:
        val = "aplic";
        break;
    case COMP20180_AIA_TYPE_APLIC_IMSIC:
        val = "aplic-imsic";
        break;
    default:
        val = "none";
...
static void comp20180_set_aia(Object *obj, const char *val, Error **errp)
{
    ...
    if (!strcmp(val, "none")) {
        s->aia_type = COMP20180_AIA_TYPE_NONE;
    } else if (!strcmp(val, "aplic")) {
        s->aia_type = COMP20180_AIA_TYPE_APLIC;
    } else if (!strcmp(val, "aplic-imsic")) {
        s->aia_type = COMP20180_AIA_TYPE_APLIC_IMSIC;
    } else {
